# AGENTS.md — 2fkinawesome (Solana D-App in development)
...
Issues live in GitHub Issues on `jrm-fusional/DegenPoker` (uses the `gh` CLI). See `docs/agents/issue-tracker.md`.
